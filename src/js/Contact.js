...
upsat=function(){
    ...
    render() {
        return (
        	...
        	<p className="hotlineTwo"><span>{this.state.hotlineTwo}</span><button onClick={this.fixeds}>修改</button></p>
        	<p className="emailOne"><span>{this.state.emailOne}</span><button onClick={this.fixeds}>修改</button></p>
        	<p className="emailTwo"><span>{this.state.emailTwo}</span><button onClick={this.fixeds}>修改</button></p>
        	<p className="web"><span>{this.state.web}</span><button onClick={this.fixeds}>修改</button></p>
        	<div className='fixs'>
        	<div className="fixs-box">
        	<h3>修改</h3>
        	<input type="text" id="fetext"/>
        	<p><button onClick={this.upsat}>确定</button><button onClick={this.clearfn}>取消</button></p>
